...
export default {
  ...
  created () {
    ...
    this.$parent.contextualHelp = "Legacy Application calling a REST API providing SQL data, "+
        ...
        "See  <b><a target='_blank' href='https://github.com/redis-developer/redis-microservices-demo/blob/master/sql-data-generator/src/main/java/io/redis/demos/debezium/sql/controllers/ActorsAPIController.java'>ActorsAPIController</a></b>";
  },
  methods: {
    async fetch () {
      this.isLoading = true
