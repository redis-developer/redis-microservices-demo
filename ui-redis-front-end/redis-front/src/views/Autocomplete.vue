...
export default {
  ...
  created() {
    this.$parent.contextualHelp = 
     ...
     "<b><a target='blank' href='https://github.com/redis-developer/redis-microservices-demo/blob/master/streams-to-redisearch-service/src/main/java/io/redis/demos/services/search/service/StreamsToRediSearch.java'> Redis key</a></b>.<br/>" +
     "The data are then accessed using a generic <b><a target='blank' href='https://github.com/redis-developer/redis-microservices-demo/blob/master/streams-to-redisearch-service/src/main/java/io/redis/demos/services/search/service/RestStatusController.java'>REST API</a></b>.<br/><br/>" +
